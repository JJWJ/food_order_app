...
const MealItemForm = (props: AppProps) => {
  ...
  return (
    <form action="/" className="text-right" onSubmit={submitHandler}>
      ...
      />
      <button className="cursor-pointer text-white font-bold bg-red-700 border border-solid border-red-700 py-1 px-4 rounded-3xl hover:bg-red-800 hover:border-red-800">
        + Add
      </button>
