...
const HeaderCartButton = (props: AppProps) => {
  ...
  const btnClass = `${"cursor-pointer border-0 bg-yellow-800 text-white py-3 px-12 flex justify-around items-center rounded-3xl font-bold hover:bg-yellow-900"} + ${
    btnBounce ? "animate-bounce" : ""
  }`;
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <span>Your Cart</span>
        <span className="bg-yellow-600 py-1 px-4 rounded-md ml-4 font-bold hover:bg-yellow-900">
          {numberOfCartItems}
        </span>
      </button>
    </React.Fragment>
