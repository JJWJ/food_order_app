...
const HeaderCartButton = () => {
    return (
        <React.Fragment>
            ...
            <button aria-label='shopping cart' className='cursor-pointer border-0 bg-yellow-800 text-white py-3 px-12 flex justify-around items-center rounded-3xl font-bold hover:bg-yellow-900'>
